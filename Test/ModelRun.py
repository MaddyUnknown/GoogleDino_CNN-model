...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv2_2 = nn.Conv2d(256, 512, 3)
        self.batch2_2 = nn.BatchNorm2d(512)
        self.relu2_2 = nn.ReLU()
        self.pool2 = nn.MaxPool2d(3, stride=2)

        
        self.fc1 = nn.Linear(512*6*31, 512)
...
model = Net()
model.load_state_dict(torch.load(r'Models\Model_v1\Model_v1'))
model.eval()
